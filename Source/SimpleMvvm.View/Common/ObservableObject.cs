...
namespace SimpleMvvm.View.Common
{
    ...
    public class ObservableObject<T> : FrameworkElement, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty ValueProperty =
                DependencyProperty.Register(nameof(Value), typeof(T), typeof(ObservableObject<T>), new PropertyMetadata(default, ValueChangedCallback));
        ...
        private static void ValueChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            eventHandler?.Invoke(thisInstance, new PropertyChangedEventArgs(nameof(Value)));
        }
    }
}