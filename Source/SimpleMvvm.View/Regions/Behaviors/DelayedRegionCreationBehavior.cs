...
namespace SimpleMvvm.View.Regions.Behaviors
{
    ...
    public class DelayedRegionCreationBehavior
    {
        ...
        protected virtual IRegion CreateRegionAdapterAndInitializeIt(DependencyObject targetElement, string regionName)
        {
            ...
            {
                throw new RegionCreationException(string.Format(CultureInfo.CurrentCulture, "RegionCreationException", regionName, ex), ex);
            }
        }
        ...
        private void WireUpTargetElement()
        {
            ...
            //todo: what's the impact of commenting this out?
