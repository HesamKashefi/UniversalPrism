...
namespace UniversalPrism.Core.Delegate
{
    /// <summary>
    /// Represents a reference to a <see cref="UniversalPrism.Core.Delegate"/> that may contain a
    /// <see cref="WeakReference"/> to the target. This class is used
    /// internally by the UniversalPrism Library.
    /// </summary>
    public class DelegateReference : IDelegateReference
    {
        ...
        /// </summary>
        /// <param name="delegate">The original <see cref="UniversalPrism.Core.Delegate"/> to create a reference for.</param>
        ...
        /// <exception cref="ArgumentNullException">If the passed <paramref name="delegate"/> is not assignable to <see cref="UniversalPrism.Core.Delegate"/>.</exception>
        ...
        /// <summary>
        /// Gets the <see cref="UniversalPrism.Core.Delegate" /> (the target) referenced by the current <see cref="DelegateReference"/> object.
        /// </summary>
        /// <value><see langword="null"/> if the object referenced by the current <see cref="DelegateReference"/> object has been garbage collected; otherwise, a reference to the <see cref="UniversalPrism.Core.Delegate"/> referenced by the current <see cref="DelegateReference"/> object.</value>
        ...
        /// <summary>
        /// Checks if the <see cref="UniversalPrism.Core.Delegate" /> (the target) referenced by the current <see cref="DelegateReference"/> object are equal to another <see cref="UniversalPrism.Core.Delegate" />.
